        ...
        <div className="mb-4">
            ...
            <div className="relative">
                {isSelect ? (
                    <>
                    <select
                    className="w-full appearance-none bg-gray-100 outline-none border border-gray-300 rounded-md py-2 px-3 pr-10 text-gray-700 leading-tight focus:outline-none focus:border-blue-500"
                    value={value}
